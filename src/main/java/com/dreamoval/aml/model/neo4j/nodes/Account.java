...
/**class is represented as a node on graph*/
@NodeEntity
public class Account {

/** the id given to the particular node on graph*/
    @GraphId
    private String id;
...
*
@param a represents a fixed measurement
@param b this is the increment on the measurement
@return the sum which corresponds to the increased value 
*/
    public String getId() {
        return id;
    }
